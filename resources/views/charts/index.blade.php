...
.chart-card:hover { box-shadow: 0 6px 24px rgba(0,0,0,0.10); }
...
.metric-card .metric-label { font-size: 13px; font-weight: 500; opacity: 0.8; margin-bottom: 6px; }
.metric-card .metric-value { font-size: 22px; font-weight: 700; }

.mc-income { background: linear-gradient(135deg, #e8f5e9 0%, #c8e6c9 100%); color: #2e7d32; }
.mc-income .metric-icon { background: rgba(46,125,50,0.15); color: #2e7d32; }
.mc-expense { background: linear-gradient(135deg, #ffebee 0%, #ffcdd2 100%); color: #c62828; }
.mc-expense .metric-icon { background: rgba(198,40,40,0.15); color: #c62828; }
.mc-saldo-pos { background: linear-gradient(135deg, #e3f2fd 0%, #bbdefb 100%); color: #1565c0; }
.mc-saldo-pos .metric-icon { background: rgba(21,101,192,0.15); color: #1565c0; }
.mc-saldo-neg { background: linear-gradient(135deg, #fce4ec 0%, #f8bbd0 100%); color: #ad1457; }
.mc-saldo-neg .metric-icon { background: rgba(173,20,87,0.15); color: #ad1457; }
.mc-ratio { background: linear-gradient(135deg, #fff3e0 0%, #ffe0b2 100%); color: #e65100; }
.mc-ratio .metric-icon { background: rgba(230,81,0,0.15); color: #e65100; }
...
.warning-banner {
    ...
    color: #e65100; font-weight: 500; margin-bottom: 24px;
}
...
.legend-item.hidden-segment { opacity: 0.4; text-decoration: line-through; }
...
.donut-center .total-label { font-size: 11px; color: #999; font-weight: 500; }
.donut-center .total-value { font-size: 18px; font-weight: 700; color: #333; }
...
.filter-bar select:focus, .filter-bar .toggle-btn:focus { border-color: #6366f1; outline: none; }
.toggle-btn.active { background: #6366f1; color: #fff; border-color: #6366f1; }

.surplus-label { color: #43a047; font-weight: 600; font-size: 11px; }
.deficit-label { color: #e53935; font-weight: 600; font-size: 11px; }
...
.upgrade-badge {
    ...
    font-size: 14px; box-shadow: 0 4px 20px rgba(99,102,241,0.4);
    text-align: center;
}
.section-title {
...
<div class="container">
    <div class="page-inner">
        ...
        <div class="warning-banner">
            ...
            <span>Pengeluaran melebihi pemasukan bulan ini sebesar <strong>{{ $metricCards['overBudgetAmount'] }}</strong></span>
        </div>
        @endif
                ...
                <div class="chart-card">
                    <div class="d-flex align-items-center justify-content-between mb-3 flex-wrap" style="gap:10px;">
                        ...
                        <div class="filter-bar">
                            <button class="toggle-btn active" id="btnNominal" onclick="setBarMode('nominal')">Nominal</button>
