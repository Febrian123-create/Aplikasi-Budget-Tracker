        ...
        <ul class="sidebar-nav-main">
            ...
            <li>
                <a href="{{ route('wishlist.index') }}"
                    class="sidebar-link {{ request()->routeIs('wishlist.index') ? 'active' : '' }}">
            ...
            @if ($canViewChart)
                <li>
                    <a href="{{ route('charts.index') }}"
                        class="sidebar-link {{ request()->routeIs('charts.index') ? 'active' : '' }}">
            ...
            @if ($canUseRecurring)
                <li>
                    <a href="{{ route('recurring.index') }}"
                        class="sidebar-link {{ request()->routeIs('recurring.index') ? 'active' : '' }}">
            ...
            <li>
                <a href="{{ route('membership.index') }}"
                    class="sidebar-link {{ request()->routeIs('membership.index') ? 'active' : '' }}">
                    <i class="bi bi-gem"></i>
